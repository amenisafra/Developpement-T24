* @ValidationCode : MjotNjA3NTEyMTI2OkNwMTI1MjoxNjMxNTM2NjI3MDI0OkFNRU5JOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIwX1NQNC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Sep 2021 13:37:07
...
*
* Implementation of ATB.CDI.SpecifiqueControl.AtbECDIBuildTfImpDrNau
*
* ENQ.DATA(INOUT) :
*
SUBROUTINE ATB.E.CDI.BUILD.TF.IMPDRNAU(ENQ.DATA)
...
* Return list of DRAWINGS records whose LC.TYPE match the list in LC.TYPE.LIST
    ...
    WHILE DR.ID:DR.POS
        ...
        R.DR.REC = LC.Contract.Drawings.ReadNau(DR.ID, DR.ERR)
...
* for the USER session
        ...
        EB.DataAccess.Das("DRAWINGS",THE.LIST,THE.ARGS,"$NAU")
