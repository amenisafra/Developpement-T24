* @ValidationCode : MjotMTQ1OTkwMzIyNDpDcDEyNTI6MTYzMTUzNjkzMTA1MDpBTUVOSTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMF9TUDQuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Sep 2021 13:42:11
...
*
* Implementation of ATB.CDI.SpecifiqueControl.AtbECDIBuildTfImpDrHis
*
* ENQ.DATA(INOUT) :
*
SUBROUTINE ATB.E.CDI.BUILD.TF.IMPDRHIS(ENQ.DATA)
...
* Return list of DRAWINGS records whose LC.TYPE match the list in LC.TYPE.LIST
    ...
    WHILE DR.ID:DR.POS
        ...
        R.DR.REC = LC.Contract.Drawings.ReadHis(R.ID, DR.ERR)
...
* for the USER session
        ...
        EB.DataAccess.Das("DRAWINGS",THE.LIST,THE.ARGS,"$HIS")
