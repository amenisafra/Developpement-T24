* @ValidationCode : MjoxNjU3NTQwNzUxOkNwMTI1MjoxNjMxNTM2MDQzOTc4OkFNRU5JOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIwX1NQNC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Sep 2021 13:27:23
...
*
* Implementation of LC.AtbRDISpecifiqueControl.AtbERdiBuildTfImpLcNau
*
* ENQ.DATA(INOUT) :
*
SUBROUTINE ATB.E.RDI.BUILD.TF.IMPLCNAU(ENQ.DATA)
...
* Return list of LC records whose LC.TYPE match the list in LC.TYPE.LIST
    ...
    WHILE LC.ID:LC.POS
        ...
        R.LC.REC = LC.Contract.LetterOfCredit.ReadNau(LC.ID, Error)
...
* Call DAS for LC
    ...
    IF SELECTION.FIELDS NE '' THEN
        ...
        EB.DataAccess.Das("LETTER.OF.CREDIT",THE.LIST,THE.ARGS,"$NAU")
    END ELSE
