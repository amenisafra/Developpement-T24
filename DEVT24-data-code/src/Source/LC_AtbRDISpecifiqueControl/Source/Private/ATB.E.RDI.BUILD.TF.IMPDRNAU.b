* @ValidationCode : MjotMTM5NDkzNjYwOTpDcDEyNTI6MTYzMTUzNTQ3NjA2OTpBTUVOSTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMF9TUDQuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Sep 2021 13:17:56
...
*
* Implementation of LC.AtbRDISpecifiqueControl.AtbERdiBuildTfImpDrNau
*
* ENQ.DATA(INOUT) :
*
SUBROUTINE ATB.E.RDI.BUILD.TF.IMPDRNAU(ENQ.DATA)
...
* Return list of DRAWINGS records whose LC.TYPE match the list in LC.TYPE.LIST
    ...
    WHILE DR.ID:DR.POS
        LC.Contract.DrawingsNau(DR.ID, R.DR.REC, DR.ERR)
